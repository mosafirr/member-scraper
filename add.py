...
for a in accounts:
    ...
    clnt = TelegramClient(f'sessions/{phn}', 15649932, 'ac748828574bf5b0ff75eef790d902df')
    clnt.connect()
    banned = []
...
for acc in to_use:
    stop = index + 60
    c = TelegramClient(f'sessions/{acc[0]}', 15649932 , 'ac748828574bf5b0ff75eef790d902df')
