...
'╚═╝  ╚═╝╚═╝╚═╝  ╚═══╝╚═════╝ ╚══════╝  ╚═══╝  ╚═╝╚══════╝╚══════╝' ,
    ...
    print(f'{r}   {r}')
    print(f'{r} Channel: @Xteambd{r}')
    print(f'{cy} Group : @Xteambdchat{cy}')
    print(f'{r}   {r}')
    ...
    if a == 1:
        ...
        with open('vars.txt', 'ab') as g:
            ...
            for number in new_accs:
                c = TelegramClient(f'sessions/{number}', 15649932 , 'ac748828574bf5b0ff75eef790d902df')
                c.start(number)
        ...
        if len(accounts) == 0:
            ...
            for account in accounts:
                phone = str(account[0])
                client = TelegramClient(f'sessions/{phone}', 15649932 , 'ac748828574bf5b0ff75eef790d902df')
                client.connect()
        ...
        webbrowser.open('https://t.me/xteambd')
        clr()
        banner()
        exit()
